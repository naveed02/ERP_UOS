...
namespace ERP_UOS
{
    public partial class frmReturnBankReceiptVoucher : Form
    {
        public frmReturnBankReceiptVoucher()
        {
            InitializeComponent();
        }
        ...
        private void frmReturnBankReceiptVoucher_Load(object sender, EventArgs e)
        {
        ...
        private void mskBankCode_DoubleClick(object sender, EventArgs e)
        {
             LookUp_GL();
        }

        private void mskAccountCode_DoubleClick(object sender, EventArgs e)
        {
             LookUp_GL();
        }
