...
{
    public partial class frmPrintViewerSubRpt3P : Form
    {
        ...
        private void ExecuteSPData()
        {
            ...
            try
            {
                ...
                frpt1.OpenSubreport("CrCashBookRecSub.rpt").SetDataSource(fDs.Tables[1]);
                frpt1.OpenSubreport("CrCashBookPaySub.rpt").SetDataSource(fDs.Tables[2]);
