...
using ERP_UOS.PrintReport;
using ERP_UOS.PrintDataSets;
using ERP_UOS.StringFun01;

namespace ERP_UOS.PrintViewer
{
    public partial class frmPrintViewerCashBook : Form
    {
        ...
        //public frmPrintViewerCashBook(string p, string p_2, string p_3, string p_4, string p_5, string p_6, string plstField, string plstType, string plstValue, dsLedgerNew ds, CrCashBookMain rpt1, string p_7)
        //{
        ...
        private void ExecuteSPData()
        {
            ...
            try
            {
                ...
                //frpt1.OpenSubreport("CrTaxVocMulti.rpt").SetDataSource(fDs.Tables[1]);
                frpt1.OpenSubreport("CrCashBookRecSub.rpt").SetDataSource(fDs.Tables[2]);
                frpt1.OpenSubreport("CrCashBookPaySub.rpt").SetDataSource(fDs.Tables[3]);
                frpt1.OpenSubreport("CrLogo.rpt").SetDataSource(fDs.Tables[4]); 
        ...
        private void ExecuteTableData()
        {
            ...
            try
            {
                ...
                frpt1.OpenSubreport("CrTaxVocDrSub.rpt").SetDataSource(fDs.Tables[2]);
                frpt1.OpenSubreport("CrTaxVocCrSub.rpt").SetDataSource(fDs.Tables[3]);
                frpt1.OpenSubreport("CrLogo.rpt").SetDataSource(fDs.Tables[4]); 
