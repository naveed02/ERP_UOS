...
{
    public partial class frmPrintViewer8 : Form
    {
        ...
        private void ExecuteSPData()
        {
            ...
            try
            {
                ...
                frpt1.OpenSubreport("CrTaxVocDebitSub.rpt").SetDataSource(fDs.Tables[2]);
                frpt1.OpenSubreport("CrTaxVocCreditSub.rpt").SetDataSource(fDs.Tables[3]);
        ...
        private void frmPrintViewer8_Load(object sender, EventArgs e)
        {
            if (fQtyType == "SP")
            {
                ExecuteSPData();
