...
{
    public partial class frmPrintViewerDayBook : Form
    {
        ...
        private void ExecuteSPData()
        {
            ...
            try
            {
                ...
                frpt1.OpenSubreport("CrDayBookRecSub.rpt").SetDataSource(fDs.Tables[2]);
                frpt1.OpenSubreport("CrDayBookPaySub.rpt").SetDataSource(fDs.Tables[3]);
