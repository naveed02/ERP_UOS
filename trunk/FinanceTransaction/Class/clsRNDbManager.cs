...
namespace ERP_UOS
{
    public class clsRNDbManager
    {
       public static string fStoreProcName;
       public static string flstField;
       public static string flstType;
       public static string flstValue;
       public static DataSet fDs;

        public static DataSet RNGetData_Set(string pQry, string strtable)
        {
            // strtable is optional: any string may be used as name to fullfull
            // formality of ds.
            SqlConnection con = new SqlConnection(clsGVar.ConString3);
        ...
        // Search Value
        // CustQry
        public static string RNGetParentID(
          string pTable,
          string pKeyFieldID,
          string pPidField,
          Int64 pSearchValue,
        ...
        public static string RNGetTitle(
            string pTable,
            string pKeyFieldID,
        ...
        // 5- Custom Qry    (Default = "" )                  
        public static string RNGetTitleAc(
            string pTable,
            string pKeyFieldID,
            string pKeyFieldTitle,
            string pSearchValue,
        ...
        //========================================
        public static int RNFindUserID(string pUserName)
        {
            // Find User ID
            int rtnUserID = 0;
            SqlConnection con = new SqlConnection(clsGVar.ConString3);
        ...
        public static int RNFindGroupID(string pGroupName)
        {
            // Find Group ID
            int rtnGroupID = 0;
            SqlConnection con = new SqlConnection(clsGVar.ConString3);
        ...
        // ====
        public static int RNFindFormID(string pFormName)
        {
            // Find Group ID
            int rtnFormID = 0;
            SqlConnection con = new SqlConnection(clsGVar.ConString3);
        ...
        public static string RNGetConfigCode(
            string pTable,
            string pKeyFieldID,
            string pWhere,
            string pCustomQry = "")
        ...
        //
        public static Int64 RNGetNextValDocID(
            string pTable,
            string pKeyFieldID,
            string pWhere,
            string pCustomQry = "")
        ...
        // 4- pCustomQry optional ""
        //
        public static Int64 RNGetValDocID(
            string pTable,
            string pKeyFieldID,
            string pWhere,
            string pCustomQry = "")
        ...
        // KeyField Name
        // Custom Qry
        public static int RNGetNextValMastID(
          string pTable,
          string pKeyFieldID,
          string pCustomQry
          )
        ...
        // KeyField Name
        // Custom Qry
        public static Int64 RNGetNextValMastIDInt64(
          string pTable,
          string pKeyFieldID,
          string pCustomQry
          )
        ...
        // Key Field Name
        // Connection string
        public static string RNGetTotalRec(
          string pTtable,
          string pFieldID,
        ...
        public static void RNSetLVHeader(
            ListView pLV,
            int pColTotal,
            string pColHeader,
            string pColWidth,
        ...
        public static void RNFillListView(
            ListView pLV,
            int pCol,
            string pSQL,
            string pFL,
        ...
        // 
        public static void RNSetGridHeader(DataGridView DGV1,
            int pColTotal,
            string pColHeader,
            string pColWidth,
            ...
            int pGridColorScheme = 1)
        {
            ...
            try
            {
                ...
                {
                    pColWidth = RNStrRepeate("10", pColTotal);
                    if (pColWidth == "Err")
                    {
                        // Reaise Error
                    }
                ...
                {
                    pColMaxInputLen = RNStrRepeate("0", pColTotal);
                ...
                {
                    pColFormat = RNStrRepeate("T", pColTotal);
                    if (pColFormat == "Err")
                    {
                        // Reaise Error
                    }
                ...
                if (pColReadyOnly.Trim().Length == 0)
                {
                    ...
                    pColReadyOnly = RNStrRepeate("1", pColTotal);
                    if (pColWidth == "Err")
                    {
                        // Reaise Error
                    }
                ...
                else
                {
                    ...
                    {
                        // All Read/Write
                        pColReadyOnly = RNStrRepeate("0", pColTotal);
                        if (pColWidth == "Err")
                        {
                            // Reaise Error
                        }
            ...
            int pGridColorScheme = 1)
        {
            ...
            try
            {
                ...
                {
                    pColMinWidth = RNStrRepeate("0", pColTotal);
                    if (pColMinWidth == "Err")
                    {
                        // Reaise Error
                    }
        ...
        public static string RNStrRepeate(string pChar, int pColTotal)
        {
            string RtnString = string.Empty;
            // Add default format to all columns when width string length = 0
            string lChar = pChar;
        ...
        public static void RNFillGridWList(
            DataGridView pDGV1,
            List<string> pList,
            bool pReadOnly = true
            )
        ...
        // ================ ExeMany =======================
        public static bool RNExeMany(List<string> pManySQL)
        {
        ...
        // ================ ExeMany =======================
        //--------------- Execute Command -----------------
        public static bool RNExeOne(string pSQL)
        {
            bool ExeSuccess = false;
            string mySQL = string.Empty;
            SqlConnection Con = new SqlConnection(clsGVar.ConString1);
        ...
        public static bool RNIDAlreadyExistWw(
            string pTable,
            string pKeyField,
            string pWhere
            )         // Ww = Without Where
        ...
        // 4- Co Data    
        public static bool RNIDAlreadyExist(
            string pTable,
            string pKeyField,
            string pID,
            string pCoData)
        ...
        // 3- To Be Search Value
        // 4- Co Data    
        public static bool RNIDAlreadyExistStrAc(
            string pTable,
            string pKeyField,
            string pID,
            string pCoData)
        ...
        // 4- Custom Query    
        //
        public static bool RNIDAlreadyExistCQ(
            string pTable,
            string pKeyField,
            string pID,
            string pQry)
        ...
        public static bool RNIsNumeric(ref object val)
        {
            if (val == null)
                return false;
        ...
        public static decimal RNConvDecimal(MaskedTextBox pmtext)
        {
            decimal rtnVal = 0;
            decimal outValue = 0;
        ...
        public static decimal RNConvDecimal(Label pmtext)
        {
            decimal rtnVal = 0;
            decimal outValue = 0;
            bool lCheckValue = false;
        ...
        public static decimal RNConvDecimal(TextBox pmtext)
        {
            decimal rtnVal = 0;
            decimal outValue = 0;
            bool lCheckValue = false;
        ...
        public static decimal RNConvDecimal(TNumEditBox pmtext)
        {
            decimal rtnVal = 0;
            decimal outValue = 0;
            bool lCheckValue = false;
        ...
        public static decimal RNConvDecimal(string pmtext)
        {
            decimal rtnVal = 0;
            decimal outValue = 0;
            bool lCheckValue = false;
        ...
        // Convert Int64
        public static Int64 RNConvInt64(CSUST.Data.TNumEditBox pmtext)
        {
            Int64 rtnVal = 0;
            Int64 outValue = 0;
            bool lCheckValue = false;
        ...
        //
        // Convert Int32
        public static Int32 RNConvInt32(string pmtext)
        {
            Int32 rtnVal = 0;
            Int32 outValue = 0;
            bool lCheckValue = false;
        ...
        // Convert Int
        public static int RNConvInt(MaskedTextBox pmtext)
        {
            int rtnVal = 0;
            int outValue = 0;
            bool lCheckValue = false;
        ...
        //
        // Convert Int64
        public static Int64 RNConvInt64(MaskedTextBox pmtext)
        {
            Int64 rtnVal = 0;
            Int64 outValue = 0;
            bool lCheckValue = false;
        ...
        // Convert Int64
        public static Int64 RNConvInt64(string pmtext)
        {
            Int64 rtnVal = 0;
            Int64 outValue = 0;
            bool lCheckValue = false;
        ...
        public static int RNConvInt(string pmtext)
        {
            int rtnVal = 0;
            int outValue = 0;
            bool lCheckValue = false;
        ...
        public static string RNConvBit(CheckBox pmChk)
        {
            string rtnVal = "0";
            try
            {
        ...
        public static string RNConvBit(string pmChk)
        {
            string rtnVal = "0";
            try
            {
        ...
        public static bool RNConvCheckBox(object pcol)
        {
            bool rtnVal = false;
            try
            {
        ...
        public static bool RNConvCheckBox(string pcol)
        {
            bool rtnVal = false;
            try
            {
        ...
        public static void RNFillDataGrid(
            DataGridView pDGV,
            string pSQL,
            string pFieldList,
            string pFieldFormat,
        ...
        //
        public static string RNPrepareGridSQL(
          DataGridView pdGv,
          string pTableName,
                    ...
                    for (int j = 0; j < lCols; j++)
                    {
                        ...
                        switch (lColType[j].Trim())
                        {
                            ...
                            case "CH":
                                if (pdGv.Rows[i].Cells[j].Value == null)
                                {
                                    lSQLValues += RNConvBit("False");
                                }
                                else
                                {
                                    lSQLValues += RNConvBit(pdGv.Rows[i].Cells[j].Value.ToString());
                                }
                                break;
                            case "CB":
                                if (pdGv.Rows[i].Cells[j].Value == null)
                                ...
                                {
                                    lSQLValues += RNConvInt(pdGv.Rows[i].Cells[j].Value.ToString());
                                }
                                break;
                            case "NI":
                                if (pdGv.Rows[i].Cells[j].Value == null)
                            ...
                            case "N4":
                                ...
                                {
                                    lSQLValues += RNConvDecimal(pdGv.Rows[i].Cells[j].Value.ToString());
                                }
                                break;
                            default:
        ...
        public static bool RNcheckStringWithInRange(string pStartString, string pEndString, string pFindString)
        {
            try
            {
        ...
        //
        public static List<Tuple<string, string, string>> RNPrepareControlAcList(string pInitialControlID)
        {
        ...
        //
        public static bool RNExistInControlAcList(List<Tuple<string, string, string>> pAcList, string pAcID)
        {
            bool rtnValue = false;
        ...
        public static string RNGetTitlnStrAcID(
            string pTable,
        ...
        // 4- Code to be searched or Located (Value)
        // 5- Custom Qry    (Default = "" )                  
        public static string RNGetTitlenNumAcID(
            string pTable,
            string pKeyFieldID,
            string pKeyFieldTitle,
            string pSearchValue,
        ...
        public static string RNVocCheckAndDisplayList(
                string pTableName,
                string pFieldName,
                int pDocTypeID,
                string pDate,
        ...
        public static string RNPrefGLIDs_Get(
            int PrefNumber)
        {
            string rtnValue = string.Empty;
            DataSet ds = new DataSet();
            ...
            // Fields 0,1,2,3 are Begin  
            tSQL = "SELECT From_Ac_ID FROM cmn_prefdtl Where ";
            tSQL += " docid=" + PrefNumber.ToString();
            tSQL += " AND isParent=0";

            try
            {
                ds = clsDbManager.GetData_Set(tSQL, "cmn_prefdtl");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    for (int dGVRow = 0; dGVRow < ds.Tables[0].Rows.Count; dGVRow++)
                    {
                        rtnValue += ds.Tables[0].Rows[dGVRow]["From_AC_ID"].ToString() + ",";
                        //lSQL += ", " + grdVoucher.Rows[dGVRow].Cells[(int)GColD.snum].Value.ToString();          // 11- Combo 1 
                    }
                    //MessageBox.Show(strDocStrID,this.Text);
                ...
                {
                    rtnValue = "Preference Code No Found!";
                    return rtnValue;
                }
            }
            catch
            {
                return "Preference Code No Found!";
                //MessageBox.Show("Unable to Get Account Code...", this.Text.ToString());
            }
        }
    ...
    //    } // Get Title ID
        ...
        public static bool RNGetBoolValue(
            string pTable,
            string pSelectFieldName,
            string pConditionFieldName,
            string pConditionFieldValue,
        ...
        //
        public static bool RNExistStringWithInRange(string pStartString, string pEndString, string pAcID)
        {
            try
            {
        ...
        //
        public static List<Tuple<string, string, string>> RNPrepareControlAcList(Int32 pParentID)
        {
            string lFromID = string.Empty;
            string lToID = string.Empty;
            string lTitle = string.Empty;
        ...
        public static string RNPrePareAdditionaWhere(List<Tuple<string, string, string>> pAcList, string pFieldName)
        {
            string rtnValue = string.Empty;
            //
            string lStartID = string.Empty;
     ...
     public static Int64 RNGetIn64Value(
     string pTable,
     string pKeyFieldID,
     string pFieldToSearch,
     Int64 pValueToSearch,
     string pCustomQry = ""
        ...
        // 4- Conditional Field Value
        // 5- Custom Qry    (Default = "" )                  
        public static int RNGetIntValue(
            string pTable,
            string pSelectFieldName,
            string pConditionFieldName,
            string pConditionFieldValue,
        ...
        // 4- Conditional Field Value
        // 5- Custom Qry    (Default = "" )                  
        public static string RNGetStrValue(
            string pTable,
            string pSelectFieldName,
            string pConditionFieldName,
            string pConditionFieldValue,
        ...
        // 4- Conditional Field Value
        // 5- Custom Qry    (Default = "" )                  
        public static DateTime RNGetDateValue(
            string pTable,
            string pSelectFieldName,
            string pConditionFieldName,
            string pConditionFieldValue,
        ...
        public static DataSet RNExecuteSP_Ret_DS(string flstField, string flstType, string flstValue, string fStoreProcName)
        {
