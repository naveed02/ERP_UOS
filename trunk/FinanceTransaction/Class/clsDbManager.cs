...
namespace ERP_UOS
{
    public class clsDbManager
    {
       ...
       public static DataSet fDs = new DataSet();
        ...
        public static DataSet GetData_Set(string pQry, string strtable)
        {
            ...
            // formality of ds.
            SqlConnection con = new SqlConnection(clsGVar.DBConnectString);
                        ...
                        switch (lColType[j].Trim())
                        {
                            ...
                            case "DT":
                                ...
                                else
                                {
                                    ...
                                    DateTime dateValue = Convert.ToDateTime(pdGv.Rows[i].Cells[j].Value.ToString());
                                    //lSQLValues += "'" + DateTime.ParseExact(dateValue.ToShortDateString(), dateFormat, CultureInfo.InvariantCulture) + "'";
                                    lSQLValues += "'" + StrF01.D2Str(dateValue) + "'";
                                }
                                break;
                            default:
                ...
                string pManualDocID)
        {
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        rtnValue += ds.Tables[0].Rows[dGVRow]["doc_id"].ToString() + " \n";
        ...
        public static string PrefGLIDs_Get(
            int PrefNumber)
        {
            string rtnValue = string.Empty;
            DataSet ds = new DataSet();
    ...
    //    } // Get Title ID
     ...
     string pCustomQry = ""
        ...
        public static DataSet ExecuteSP_Ret_DS(string flstField, string flstType, string flstValue, string fStoreProcName)
        {
